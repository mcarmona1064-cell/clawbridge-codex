 ...
 * approval handler) hook in without core calling into the module directly.
 *
...
async function deliverMessage(
  ...
  if (!msg.channel_type || !msg.platform_id) {
    ...
    throw new Error(
      `Message ${msg.id} missing routing fields: channel_type=${msg.channel_type} platform_id=${msg.platform_id}`,
    );
  }
